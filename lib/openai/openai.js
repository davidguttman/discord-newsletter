...
async function summarizeMessages(messages, options = {}) {
  ...
  const focusPrompt = options.focusPrompt || "";

  try {
    const systemPrompt = `You are an in-depth tech journalist. You write detailed reports, and you do not gloss over specifics.${
